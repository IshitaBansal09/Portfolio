...
const profile = {
    ...
    skills: [
        'C++', 'JavaScript', 
        'ReactJS', 'NextJS', 'NodeJS', 'ExpressJS', 'TailwindCSS',
        'MySQL', 'MongoDB'
    ],
    tools: [
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  Full-Stack Developer | Building AI-powered web apps | MERN & AWS | 400+ DSA problems
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://github.com/IshitaBansal09" target = "_blank"
                ...
                {/* Contact Button */}
                <a
                  href="https://drive.google.com/drive/folders/1g3N4az5lujrEco2omsnwwVkAla516U7p?usp=drive_link" target="_blank"
